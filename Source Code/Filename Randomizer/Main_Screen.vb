                ...
                If dinfo.Parent.Exists Then
                    ...
                    For Each finfo As FileInfo In dinfo.GetFiles()
                        ...
                        Try
                            ...
                            Dim randomizedname, randomstub As String
                            randomizedname = ""
                            randomstub = ""
                            Dim MyValue As Integer
                            Randomize()   ' Initialize random-number generator.
                            MyValue = CInt(Int((9999 * Rnd()) + 1))
                            randomstub = MyValue.ToString
                            While randomstub.Length < 4
                                randomstub = "0" & randomstub
                            End While
                            randomizedname = randomizedname & randomstub
                            Randomize()   ' Initialize random-number generator.
                            MyValue = CInt(Int((9999 * Rnd()) + 1))
                            randomstub = MyValue.ToString
                            While randomstub.Length < 4
                            ...
                            End While
                            randomizedname = randomizedname & randomstub
                            randomizedname = randomizedname & Format(Now, "ddHHmmss") & finfo.Name



                            Dim savename As String = savedirectory & CleanUpHash(GenerateHash(randomizedname)) & ("." & finfo.Extension).Replace("..", ".")
                            Try
